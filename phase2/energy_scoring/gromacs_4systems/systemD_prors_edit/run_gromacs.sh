#!/bin/bash
# GROMACS simulation script for systemD_prors_edit
# Run from: /storage/kiran-stuff/aaRS/phase2/energy_scoring/gromacs_4systems/systemD_prors_edit

set -e

GMX="gmx"  # or gmx_mpi

echo "=== Setting up systemD_prors_edit ==="
...
echo "=== systemD_prors_edit complete ==="
