#!/bin/bash
# GROMACS simulation script for systemC_thrrs_ILE
# Run from: /storage/kiran-stuff/aaRS/phase2/energy_scoring/gromacs_4systems/systemC_thrrs_ILE

set -e

GMX="gmx"  # or gmx_mpi

echo "=== Setting up systemC_thrrs_ILE ==="
...
echo "=== systemC_thrrs_ILE complete ==="
