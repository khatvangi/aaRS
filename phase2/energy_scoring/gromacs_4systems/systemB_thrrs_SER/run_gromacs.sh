#!/bin/bash
# GROMACS simulation script for systemB_thrrs_SER
# Run from: /storage/kiran-stuff/aaRS/phase2/energy_scoring/gromacs_4systems/systemB_thrrs_SER

set -e

GMX="gmx"  # or gmx_mpi

echo "=== Setting up systemB_thrrs_SER ==="
...
echo "=== systemB_thrrs_SER complete ==="
